...
const experiencesData = [
  {
    ...
    address: "Remote",
    description:
      "Part-time Software Engineer at ReviewsAI, building dynamic web and desktop applications with React.js and Tauri, mainly focused on engineering document automation and workflow efficiency.",
    date: "2025 – Present",
  ...
  },
  {
    ...
    address: "On-Site",
    description:
      "Currently working as a Frontend Developer at Aayulogic Private Limited. I utilize my skills in Vue.js and its ecosystem to build dynamic web applications focused primarily on automating HRMS features.",
    date: "2025 – Present",
  ...
  },
  {
    ...
    description:
      "Graduated with a Bachelor of Science in Computer Science and Information Technonology in 2024.",
    date: "2019-2024",
    icon: <GraduationCap />,
  },
];
        ...
        <div className="text-center max-w-5xl mx-auto">
          ...
          <div className="relative">
            ...
            {experiencesData.map((item, index) => (
              <div
                key={index}
                className={`relative flex items-start mb-12 ${index % 2 === 0 ? "flex-row-reverse" : "flex-row"} w-full justify-center`}
              >
                {/* Content Box */}
                <div
